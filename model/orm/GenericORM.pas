...
Uses Db, Rtti, CAtribEntity, TypInfo, SysUtils, Classes, StrUtils,
...
var
  ...
  TypObj: TRttiType;
  Prop: TRttiProperty;
  strInsert, strFields,strParams: String;
  Atributo: TCustomAttribute;
  Lc_Value : String;
begin
  Try
...
var
  ...
  TypObj: TRttiType;
  Prop: TRttiProperty;
  strReplace, strFields,strParams, StrKeys: String;
  Atributo: TCustomAttribute;
  Lc_Value : String;
  Lc_IndKey : Integer;
begin
...
class procedure TGenericORM._get<T>(Qry:TFDQuery;Obj: T);
var
  Contexto: TRttiContext;
  TypObj: TRttiType;
  Prop: TRttiProperty;
